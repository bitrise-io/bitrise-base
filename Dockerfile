...
#
# Install Bitrise CLI
RUN curl -fL https://github.com/bitrise-io/bitrise/releases/download/1.3.0/bitrise-$(uname -s)-$(uname -m) > /usr/local/bin/bitrise
...
ENV BITRISE_DOCKER_REV_NUMBER_BASE 2016_03_26_1
CMD bitrise --version
